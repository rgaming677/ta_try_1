...
<head>
    ...
    <link href="<?= base_url('asset 2'); ?>/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
...
<body class="bg-gradient-primary">
    ...
    <script src="<?= base_url('asset 2'); ?>/vendor/jquery/jquery.min.js"></script>
    <script src="<?= base_url('asset 2'); ?>/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="<?= base_url('asset 2'); ?>/vendor/jquery-easing/jquery.easing.min.js"></script>
